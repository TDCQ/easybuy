...
<div id="main" class="wrap">
    <div id="menu-mng" class="lefter">
        <div class="box">
            <dl>
                <dt>用户管理</dt>
                <dd><em><a href="user-add.html">新增</a></em><a href="/manager/getUsers.html">用户管理</a></dd>
                <dt>商品信息</dt>
    ...
    <div class="main">
        <h2>管理首页</h2>
        <iframe id="iframe" name="main" src="welcome.html" frameborder="0" scrolling="no" width="100%"></iframe>
    </div>
    <div class="clear"></div>
</div>
<div id="footer">
